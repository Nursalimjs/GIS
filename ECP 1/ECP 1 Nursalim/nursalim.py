...
POSTGIS_TABLE = dict(
    ...
    password='12345',
    dbname='nursalim',
    table='(select ST_MPolyFromText(ST_AsText(geom)) as geom, nama from baluran) as baluran')
LAYER_NAME = 'tamanbaluran'
...
def render_tile(layer, z, x, y):
    ...
    label = mapnik.TextSymbolizer(mapnik.Expression('[nama]'), 'DejaVu Sans Book',12,mapnik.Color('red'))
    label.halo_radius = 1
